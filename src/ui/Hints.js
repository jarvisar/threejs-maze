 ...
 * `pad` words a tip for a controller, given its button names; tips without one aren't shown to controller players.
 */
const HINTS = [
    { at: 4, id: 'flashlight', text: 'Press "F" to toggle the flashlight.', pad: (b) => `Press "${b.x}" to toggle the flashlight.` },
    { at: 16, id: 'lights', text: 'Press "2" or "G" to toggle dynamic lights.' },
    { at: 28, id: 'sprint', text: 'Hold "Shift" to sprint.', pad: () => 'Click the left stick to sprint.' },
    ...
    { at: 72, id: 'edit', text: 'Press "X" to toggle edit mode.', pad: (b) => `Press "${b.y}" to toggle edit mode.` },
...
export class Hints {
    ...
    constructor(toast) {
        ...
        this.situations = {
            ...
            edits: { text: EDITS_SAVED, pad: () => EDITS_SAVED },
        };
    }
    ...
    /** @param {{ text: string, pad?: (labels: import('../input/Gamepad.js').ButtonLabels) => string }} hint */
    _text(hint) {
